...
const Login = () => {
  ...
  const authenticate = async (address,chainId) => {
    try {
      // Some asynchronous operation, e.g., fetching data from an API
      const res = await axios.get(`/request_challenge?address=${address}&chainId=${chainId}`)
  ...
  const verify = async (params) => {
    try {
    const result = await axios.post(`verify_challenge/`, params, {
      headers: {
  ...
  //   console.log('account', account, 'chainId', chainId,'message',message ,'signature',signature);
  //   }
  // }
  //    fetchData();
  // }, [message]);
  ...
  //     console.log('account', account, 'chainId', chainId,'message',message, user,'user');
  //   }
  //  fetchData();
  // }, [signature]);
  ...
  // useEffect( () => {
  //   console.log('account', account, 'chainId', chainId,'message',message, user,'user');
  //   console.log('tresrsfdfsadfs',user);
  //  // isLoggedIn = true;
